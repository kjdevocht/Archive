...
/**
 * Server Handler to process /moves/Year_of_Plenty
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                YearOfPlentyRequest request = translator.getYearOfPlentyRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().yearOfPlenty(request, credentials)).getResult();
                if(gameModel == null) {
