...
/**
 * Server Handler to process /moves/sendChat
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                SendChatRequest request = translator.getSendChatRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().sendChat(request,credentials)).getResult();
                if(gameModel == null) {
