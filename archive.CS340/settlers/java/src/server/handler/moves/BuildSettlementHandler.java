...
/**
 * Server Handler to process /moves/buildSettlement
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try {
                ...
                BuildSettlementRequest request = translator.getBuildSettlementRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().buildSettlement(request, credentials)).getResult();

                if(gameModel == null) {
                    throw new Exception("unable place settlement");
                }
