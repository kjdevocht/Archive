...
/**
 * Server Handler to process /moves/discardCards
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try {
                ...
                DiscardCardsRequestServer request = translator.getDiscardCardsRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().discardCards(request, credentials)).getResult();
