...
/**
 * Server Handler to process /moves/Monopoly
 */
public class MonopolyHandler implements IHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                MonopolyRequest request = translator.getMonopolyRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().monopoly(request, credentials)).getResult();
                if(gameModel == null) {
