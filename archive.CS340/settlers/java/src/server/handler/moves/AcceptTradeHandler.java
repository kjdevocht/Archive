...
/**
 * Server Handler to process /moves/acceptTrade
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                AcceptTradeRequest request = translator.getAcceptTradeRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().acceptTrade(request,credentials)).getResult();
                if(gameModel == null) {
