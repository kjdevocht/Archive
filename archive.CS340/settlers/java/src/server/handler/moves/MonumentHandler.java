...
/**
 * Server Handler to process /moves/Monument
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                MonumentRequest request = translator.getMonumentRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().monument(request, credentials)).getResult();
                if(gameModel == null) {
