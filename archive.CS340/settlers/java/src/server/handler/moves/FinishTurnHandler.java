...
/**
 * Server Handler to process /moves/finishTurn
 */
public class FinishTurnHandler implements IHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        Logger.getSingleton().info("Finish Turn Handler");
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                FinishTurnRequest request = translator.getFinishTurnRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().finishTurn(request, credentials)).getResult();
