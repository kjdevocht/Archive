...
/**
 * Server Handler to process /moves/buyDevCard
 */
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                BuyDevCardRequest request = translator.getBuyDevCardRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().buyDevCard(request, credentials)).getResult();
                if(gameModel == null) {
