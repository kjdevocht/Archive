...
/**
 * Server Handler to process /moves/Soldier
 */
public class SoldierHandler implements IHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                SoldierRequest request = translator.getSoldierRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().soldier(request, credentials)).getResult();
                if(gameModel == null) {
