...
/**
 * Server Handler to process /moves/robPlayer
 */
public class RobPlayerHandler implements IHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try {
                ...
                RobPlayerRequest request = translator.getRobPlayerRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().robPlayer(request, credentials)).getResult();
