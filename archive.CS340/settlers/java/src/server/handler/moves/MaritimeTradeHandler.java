...
/**
 * Server Handler to process /moves/maritimeTrade
 */
public class MaritimeTradeHandler implements IHandler {
    @Override
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if(!httpExchange.getRequestMethod().equals("POST")) {
            ...
            try{
                ...
                MaritimeTradeRequest request = translator.getMaritimeTradeRequest();
                IGameModel gameModel = new ModelResult(ServerFacade.getSingleton().maritimeTrade(request, credentials)).getResult();
                if(gameModel == null) {
