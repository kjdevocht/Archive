...
public class Player implements IPlayer{
	 ...
	 */
	public Player(String name, int playerId, CatanColor color, int playerIndex) {
		this.name = name;
    ...
    @Override
    public void buyRoad(boolean isFree) {
        if(!isFree) {
            resources.setQuantity(ResourceType.BRICK, resources.getQuantity(ResourceType.BRICK) - 1);
            resources.setQuantity(ResourceType.WOOD, resources.getQuantity(ResourceType.WOOD) - 1);
        }
        roads--;
    }
    @Override
    public void buySettlement(boolean isFree) {
        if(!isFree) {
            resources.setQuantity(ResourceType.BRICK, resources.getQuantity(ResourceType.BRICK) - 1);
            resources.setQuantity(ResourceType.WOOD, resources.getQuantity(ResourceType.WOOD) - 1);
            resources.setQuantity(ResourceType.WHEAT, resources.getQuantity(ResourceType.WHEAT) - 1);
            resources.setQuantity(ResourceType.SHEEP, resources.getQuantity(ResourceType.SHEEP) - 1);
        }
        settlements--;
    }
    @Override
    public void buyCity() {
        ...
        resources.setQuantity(ResourceType.ORE, resources.getQuantity(ResourceType.ORE) - 3);
        resources.setQuantity(ResourceType.WHEAT, resources.getQuantity(ResourceType.WHEAT) - 2);
    ...
    public void buyDevCard() {
        ...
        resources.setQuantity(ResourceType.ORE, resources.getQuantity(ResourceType.ORE) - 1);
        resources.setQuantity(ResourceType.WHEAT, resources.getQuantity(ResourceType.WHEAT) - 1);
        resources.setQuantity(ResourceType.SHEEP, resources.getQuantity(ResourceType.SHEEP) - 1);
