...
public class MapComponent extends JComponent
{
	...
	private EdgeLocation tempRoad;
	public void placeTempRoad(EdgeLocation edgeLoc, CatanColor color)
	{
		if(tempRoad != null){
			removeTempRoad();
		}
		tempRoad = edgeLoc.getNormalizedLocation();
		roads.put(tempRoad, color);
		this.repaint();
	}
	
	public void removeTempRoad()
	{
		if(tempRoad == null)
			return;
