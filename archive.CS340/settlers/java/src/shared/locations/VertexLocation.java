...
import server.model.map.LocationComparer;
...
public class VertexLocation {
	...
	public VertexLocation getNormalizedLocation() {
		...
		case NorthEast:
			return this;
		case West:
			return new VertexLocation(hexLoc.getNeighborLoc(EdgeDirection.SouthWest),
					VertexDirection.NorthEast);
		case SouthWest:
			return new VertexLocation(hexLoc.getNeighborLoc(EdgeDirection.South),
					VertexDirection.NorthWest);
		case SouthEast:
			return new VertexLocation(hexLoc.getNeighborLoc(EdgeDirection.South),
					VertexDirection.NorthEast);
		case East:
			return new VertexLocation(hexLoc.getNeighborLoc(EdgeDirection.SouthEast),
					VertexDirection.NorthWest);
		default:
			assert false;
			return null;
    ...
    public static String getVertexString(VertexLocation vertexLocation) {
    ...
    public VertexLocation getRandomVariation(){
        Random rand = new Random();
        int i = rand.nextInt(2);
        return LocationComparer.getVertexLocations(this).get(i);
    }
}
