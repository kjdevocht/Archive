/*Kevin DeVocht Assignment 13 Exercise 8. Write a function, kpopSale, 
that consumes an inventory and produces an inventory where all K-Pop 
CDs are discounted by 10%.
*/
...
class Inventory 
{
	...
	//kpopSale: Inventory->Inventory
	//Purpose: add a ten percent discount to all CDs in the K-Pop category
	virtual Inventory* kpopSale() = 0;
