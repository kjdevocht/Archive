/*Kevin DeVocht Assignment 13 Exercise 1. Develop a data definition for CDs. 
You should at least keep track of the title, artist, price, number in stock, 
and its category (such as "K-Pop", "Soundtrack", "Nerdcore", etc.) Make 8 CD 
objects with at least three categories.
*/
