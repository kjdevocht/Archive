...
class Parser
{
	...
	void predicateListParser(vector<Predicate>& predLst)
	{
		//Function Variables
		Predicate pred;
	...
	void parameterListParser(vector<Parameter>& paramLst)
	{
		//Function Variables
		Parameter param;
