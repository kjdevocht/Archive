...
class Lex {
    ...
    private:
        ...
        //Auxiliary Methods
			...
			void sawAQuote(State& result, char& character);
			void sawPound(State& result, char& character);
			void sawColon(State& result, char& character);
			void possibleId(State& result, char& character);
			void processingMultiComment(State& result, char& character);
			void processingComment(State& result, char& character);
			void processingString(State& result, char& character);
			void possibleEndOfMultiComment(State& result, char& character);
			void possibleEndofString(State& result, char& character);
            State nextState();
